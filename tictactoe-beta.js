...
var cmds = {
	...
	c: function (target, room, user, connection, cmd) {
		...
		connection.send('|pm|' + target.getIdentity() + '|' + user.getIdentity() + '|/html You have challenged ' + target.getIdentity() + ' to a game of Tic-Tac-Toe. Waiting for their response...');
